...
ODIR=obj
LDIR=./lib
LIBS=-lglfw -lopengl32 -lglew32 -lAntTweakBar
...
testgame: src/main.cpp gameobj.o graphics.o shaders.o
	$(CC) $(CFLAGS) src/main.cpp -o testgame.exe obj/gameobj.o obj/graphics.o obj/shaders.o include/AntTweakBar.h $(PCFLAGS)
